...
parser.add_argument('--convo-weights', type=str,
                    default='./convo-weights/my_weights_500.hdf5',
                    help='path to weights of model')
...
print('[i] The weights of convo model file: ', args.convo_weights)
print('###########################################################\n')
...
def _main():
    wind_name = 'face detection using YOLOv3&Convo'
    ...
    while True:
        ...
        faces,coor = post_process(frame, outs, CONF_THRESHOLD, NMS_THRESHOLD,args.convo_weights)
        print('[i] ==> # detected faces: {}'.format(len(faces)))
        print('#' * 60)
              

        # crop faces and draw roi (face detection roi) 
#        counter=0
#        for l,t,w,h in faces:
#            face_im=frame[t:t+h,l:l+w,:]
#            #print(face_im.shape)
#            #cv2.imshow('face',face_im)
#            my_name='face_'+str(counter)+'.jpg'
#            cv2.imwrite(os.path.join(args.output_dir, my_name), face_im.astype(np.uint8))
#            counter+=1
